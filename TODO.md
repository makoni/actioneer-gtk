...
- [🔄] Continue trimming `src/ui/detail_view/mod.rs`: run-filter persistence and refresh logic now lives in `run_filters.rs`, next up is splitting the remaining workflow list rendering helpers.
